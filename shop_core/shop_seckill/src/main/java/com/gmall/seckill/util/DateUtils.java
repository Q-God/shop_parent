...
public class DateUtils {
    ...
    public static int truncatedCompareTo(final Date date1, final Date date2, final int field) {
        return org.apache.commons.lang.time.DateUtils.truncatedCompareTo(date1, date2, field);
    }
    ...
    public static boolean dateCompare(Date beginDate, Date endDate) {
        // endDate > beginDate
        return DateUtils.truncatedCompareTo(beginDate, endDate, Calendar.SECOND) != 1;
        // beginDate  <= endDate
    }
